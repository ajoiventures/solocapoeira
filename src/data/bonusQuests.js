...
// Capoeira Cord Ranks — mapped to Solo Leveling tiers (U through S)
// U=No Cord → G=Green → F=Green/Yellow → E=Yellow → D=Blue/Yellow →
// C=Blue → B=Blue/Yellow/Green → A=Four Cords → S=White/Mestre
export const RANKS = [
  {
